...
The JupyterLab Notebook emvironment is a document-centric environment with two main views: a file browser, and a single page notebook editor.

 style fully initialised, you will see the contents page for the Jupyter notebook environment as shown in {numref}`jupyter_nb_v7_home`.

TO DO 
```{figure} md_assets/media/TO DO.png
:name: jupyter_nb_v7_home
:width: 5.772370953630796in

The Jupyter notebook v7. contents page

A screenshot showing a Jupyter notebook version 7 homepage with a single content directory displayed.
